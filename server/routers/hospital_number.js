...
const HospitalNumberData = require("../database/models/hospital_number");
const HospitalManagerData = require("../database/models/hospital_manager");
const UserData = require("../database/models/user");
const {isValidId} = require("../utils");
const router = new express.Router();
router
    .get("/hospital_number", auth, async function (req, res) {
        try {
